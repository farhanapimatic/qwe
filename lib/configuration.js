...
environmentsMap[environments.PRODUCTION][servers.BIBCODE_QUERY_PORT] = 'http://adsabs.harvard.edu/';
...
const Configuration = {
     ...
     */
    getBaseUri(server) {
        const url = environmentsMap[this.currentEnvironment][server || servers.BIBCODE_QUERY_PORT];
        const urlParams = {
        };
